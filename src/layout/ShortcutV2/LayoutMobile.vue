<template>
  <div class="shortcut sticky">
    <template v-if="showSearchInput">
      <div class="searchBox">
        <el-button type="text" icon="el-icon-arrow-left" circle @click="showSearchInput = false"></el-button>
    ...
    <template v-else>
      ...
      <div class="center">
        <div class="searchBox">
          <el-button type="text" icon="el-icon-search" circle
            @click="showSearchInput = true"></el-button>
